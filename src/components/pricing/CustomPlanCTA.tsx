    ...
    <div className="mt-12 max-w-3xl mx-auto">
      <div className="bg-card rounded-xl p-8 border border-brand-neutral-300 hover:border-brand-accent/60 transition-colors shadow-lg">
        <div className="text-center">
          ...
          <Button 
            size="lg"
            className="bg-gradient-to-r from-brand-accent to-brand-highlight hover:from-brand-accent-dark hover:to-brand-highlight-dark text-white uppercase tracking-wide"
          >
