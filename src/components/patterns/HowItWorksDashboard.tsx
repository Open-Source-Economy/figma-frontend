...
interface HowItWorksDashboardProps {
  className?: string;
  onNavigation?: (href: string) => void;
}

export function HowItWorksDashboard({ className = '', onNavigation }: HowItWorksDashboardProps) {
  const processSteps = [
    {
      step: '01',
    ...
    <section className={`py-16 md:py-24 bg-gradient-to-r from-background to-brand-secondary/30 ${className}`}>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeader
          ...
          description="Real-time enterprise dashboard with live metrics and expert availability"
          spacing="lg"
          titleLevel="h2"
          align="center"
          maxWidth="3xl"
