...
export function FeaturedVendors({ className = '', onVendorClick }: FeaturedVendorsProps) {
  ...
  const vendors: VendorCardProps[] = [
    {
      ...
      onLearnMore: () => onVendorClick?.('Vue Excellence Partners')
    },
    {
      ...
      onLearnMore: () => onVendorClick?.('React Native Builders')
    },
    {
      ...
      onLearnMore: () => onVendorClick?.('Next.js Architects')
    },
    {
      ...
      onLearnMore: () => onVendorClick?.('TypeScript Guild')
    }
  ];
    ...
    <section className={`py-24 relative overflow-hidden ${className}`}>
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-brand-neutral-900 mb-6">
            Featured Open‑Source Vendors
          </h2>
