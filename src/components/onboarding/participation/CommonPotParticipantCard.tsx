...
import { Heart, CheckCircle2, Handshake, Zap, ArrowRight } from 'lucide-react';
...
export const CommonPotParticipantCard: React.FC<CommonPotParticipantCardProps> = ({
  isSelected,
  onSelect,
}) => {
  return (
    <div className="max-w-2xl mx-auto relative group">
      ...
      <div className={`absolute -inset-1 bg-gradient-to-r from-brand-highlight/30 via-brand-warning/20 to-brand-highlight/30 rounded-2xl blur-2xl transition-opacity duration-300 ${
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-brand-neutral-600 mb-4">
              Benefit from funds contributed by Service Providers to support community work that wouldn't otherwise be funded. Focus on your open source project while the ecosystem sustains you.
            </p>
