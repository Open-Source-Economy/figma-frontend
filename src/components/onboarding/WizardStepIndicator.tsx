    ...
    <div className="w-full pt-10 pb-4">
      ...
      <div className="md:hidden">
        ...
        <div className="mt-4 p-4 bg-brand-card-blue rounded-lg border border-brand-neutral-300/20">
          ...
          <p className="text-brand-neutral-900">
                  ...
                  >
                    ...
                    <div className="relative">
                      {isPast || isCompleted ? (
                        ...
                        <span className={`font-semibold ${isCurrent ? 'text-base text-white' : isInProgress ? 'text-sm text-brand-accent' : 'text-sm text-brand-neutral-600'}`}>
                          {stepNumber}
                        </span>
                      )}
                    </div>
