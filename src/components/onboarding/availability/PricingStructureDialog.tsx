...
/**
 * PricingStructureDialogContent - Content explaining how enterprise pricing works
 * Used in PricingInfoBanner (Step 4) to show transparent pricing breakdown
 */
export const PricingStructureDialogContent: React.FC = () => {
  return (
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  <p className="text-xs text-brand-neutral-700">
                    <strong className="text-brand-success">Note:</strong> Project and dependency distribution is decided collaboratively with you and other maintainers.
                  </p>
                </div>
              </div>
            </div>
