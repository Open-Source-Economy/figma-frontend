...
export function DecorativeOrb({
  ...
  const getSizeClasses = () => {
    switch (size) {
      ...
      case 'extra-large': return 'w-40 h-40';
  ...
  const getPositionClasses = () => {
    ...
    switch (position) {
      case 'top-left': return `${basePosition} -top-8 -left-8`;
      case 'top-right': return `${basePosition} -top-8 -right-8`;
      case 'bottom-left': return `${basePosition} -bottom-8 -left-8`;
      case 'bottom-right': return `${basePosition} -bottom-8 -right-8`;
      default: return `${basePosition} -top-8 -right-8`;
    }
  };
  ...
  const getBlurClass = () => {
    switch (size) {
      case 'small': return 'blur-lg';
      case 'medium': return 'blur-xl';
      case 'large': return 'blur-2xl';
      case 'extra-large': return 'blur-3xl';
      default: return 'blur-xl';
    }
  };
