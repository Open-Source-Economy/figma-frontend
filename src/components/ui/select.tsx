...
function SelectTrigger({
  ...
  const variantStyles = {
    default: "border-[color:var(--form-border)] bg-[color:var(--form-background)] hover:border-[color:var(--form-border-hover)] hover:bg-[color:var(--form-background-hover)] hover:shadow-[var(--form-elevation-hover)] hover:-translate-y-0.5 focus:border-[color:var(--form-border-focus)] focus:bg-[color:var(--form-background-focus)] focus:shadow-[var(--form-elevation-focus)] focus:-translate-y-1 focus:ring-2 focus:ring-[color:var(--form-ring-color)]/15",
    outline: "border-2 border-brand-primary/20 bg-transparent hover:border-brand-accent/40 hover:shadow-[var(--form-elevation-hover)] focus:border-brand-accent focus:shadow-[var(--form-elevation-focus)] focus:ring-2 focus:ring-brand-accent/15",
    filled: "border-transparent bg-gradient-to-r from-muted/80 to-brand-primary/5 hover:from-muted hover:to-brand-primary/10 hover:shadow-[var(--form-elevation-hover)] focus:border-brand-accent focus:from-background focus:to-brand-accent/10 focus:shadow-[var(--form-elevation-focus)]",
    ghost: "border-transparent bg-transparent hover:bg-gradient-to-r hover:from-brand-primary/5 hover:to-brand-accent/5 hover:shadow-[var(--form-elevation-hover)] focus:border-brand-accent/50 focus:bg-gradient-to-r focus:from-brand-primary/10 focus:to-brand-accent/10 focus:shadow-[var(--form-elevation-focus)]",
    success: "border-brand-success hover:border-brand-success focus:border-brand-success focus:shadow-[var(--form-elevation-success)] focus:ring-brand-success/15",
    ...
    warning: "border-brand-warning/50 hover:border-brand-warning/70 focus:border-brand-warning focus:shadow-[var(--form-elevation-focus)] focus:ring-brand-warning/15",
  };
...
function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpButton
      ...
      className={cn(
        "flex cursor-default items-center py-2 pl-3",
        className,
      )}
      {...props}
    >
