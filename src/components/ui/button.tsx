  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-medium transition-all duration-300 ease-in-out cursor-pointer outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 active:scale-[0.98] active:transition-transform active:duration-75 group relative overflow-hidden",
  {
    variants: {
      variant: {
        ...
        default: "bg-brand-accent text-white shadow-lg shadow-brand-accent/25 hover:bg-brand-accent-dark hover:shadow-xl hover:shadow-brand-accent/30 hover:scale-105 border-0 focus-visible:ring-brand-accent/30",
        
        // Enhanced primary variant using brand colors
        primary: "bg-brand-primary text-white border border-brand-primary hover:bg-brand-primary-dark hover:border-brand-primary-dark hover:shadow-md focus-visible:ring-brand-primary/30 active:bg-brand-primary-dark active:shadow-sm",
        
        // Brand Outline - Sophisticated subtle effects
        outline: "border-2 border-brand-primary/20 text-foreground bg-transparent hover:border-brand-accent/40 hover:bg-gradient-to-r hover:from-brand-primary/5 hover:via-brand-accent/5 hover:to-brand-highlight/5 hover:shadow-lg backdrop-blur-sm focus-visible:ring-brand-accent/30",
        
        // Enhanced secondary variant using brand colors
        secondary: "bg-brand-secondary text-foreground border border-brand-secondary hover:bg-brand-secondary-dark hover:border-brand-secondary-dark hover:shadow-md focus-visible:ring-brand-secondary/30 active:bg-brand-secondary-dark active:shadow-sm",
        
        // Enhanced accent variant
        accent: "bg-brand-accent text-white border border-brand-accent hover:bg-brand-accent-dark hover:border-brand-accent-dark hover:shadow-md focus-visible:ring-brand-accent/30 active:bg-brand-accent-dark active:shadow-sm",
        
        // Enhanced destructive variant
        destructive: "bg-brand-error text-white border border-brand-error hover:bg-brand-error/90 hover:border-brand-error/90 hover:shadow-md focus-visible:ring-brand-error/30 active:bg-brand-error/80 active:shadow-sm",
        
        // Enhanced ghost variant with brand colors
        ghost: "text-foreground hover:bg-gradient-to-r hover:from-brand-primary/10 hover:via-brand-accent/10 hover:to-brand-highlight/10 hover:text-brand-primary hover:shadow-sm focus-visible:ring-brand-accent/30 active:bg-brand-accent/20",
        ...
        success: "bg-gradient-to-r from-brand-success to-brand-success-light text-white border-0 hover:shadow-lg hover:shadow-brand-success/25 hover:scale-105 focus-visible:ring-brand-success/30 active:shadow-sm",
        
        // Warning variant with gradient enhancement
        warning: "bg-gradient-to-r from-brand-warning to-brand-warning-light text-white border-0 hover:shadow-lg hover:shadow-brand-warning/25 hover:scale-105 focus-visible:ring-brand-warning/30 active:shadow-sm",
        
        // Brand Gradient - Full brand journey (for special occasions)
        gradient: "bg-gradient-to-r from-brand-primary via-brand-accent to-brand-highlight text-white shadow-lg shadow-brand-primary/25 hover:shadow-xl hover:shadow-brand-accent/30 hover:scale-105 border-0 focus-visible:ring-brand-accent/30",
