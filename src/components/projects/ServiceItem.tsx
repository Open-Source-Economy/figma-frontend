...
export function ServiceItem({ name, description, icon: Icon, accentColor, responseTime }: ServiceItemProps) {
  return (
      ...
      <div className="flex-1">
        ...
        {responseTime && (
          <div className="flex items-center gap-1.5 mt-2">
            ...
            <span className="text-brand-neutral-500 text-xs">Response: {responseTime}</span>
          </div>
        )}
      </div>
    </div>
