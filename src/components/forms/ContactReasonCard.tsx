...
export function ContactReasonCard({
  id,
  label,
  description,
  icon: Icon,
    ...
    >
      <div className="flex items-start gap-3">
        <Icon className={cn(
          ...
          isSelected ? 'text-brand-accent' : 'text-brand-neutral-600'
        )} />
        <div className="flex-1 min-w-0">
          <div className={cn(
            'text-base mb-1',
            isSelected ? 'text-brand-neutral-950' : 'text-brand-neutral-800'
          )}>
            {label}
          </div>
