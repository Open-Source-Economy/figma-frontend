...
import { ValidatedInput, ValidatedTextarea } from '../forms/ValidatedInput';
import { ContactReasonCard } from '../forms/ContactReasonCard';
...
interface ContactPageProps {
  ...
  demoState?: 'idle' | 'submitting' | 'success' | 'error';
}
...
const CONTACT_REASONS = [
  {
    ...
    details: 'Are you an open source maintainer interested in earning sustainable income for your work? Join our platform to connect with enterprises that depend on your projects. You\'ll maintain full control of your code while receiving fair compensation for priority support, bug fixes, and feature development.'
  },
  {
    id: 'request-project',
    ...
    details: 'Want to see a specific open source project added to our platform? Submit a request with the project details, and we\'ll evaluate it for inclusion based on community demand, ecosystem impact, and maintainer availability.'
  },
  {
    id: 'enterprise',
    ...
    details: 'Explore how our enterprise solutions can help your organization get direct access to expert maintainers, prioritize critical bug fixes, and ensure long-term support for your open source dependencies. We offer custom SLAs, dedicated support, and transparent pricing.'
  },
  {
    id: 'partnership',
    ...
    details: 'Interested in partnering with us? We\'re open to collaborations that strengthen the open source ecosystem, including foundation partnerships, corporate sponsorships, technology integrations, and community initiatives.'
  },
  {
    id: 'volunteer',
  ...
  },
  {
    ...
    details: 'Media professionals can reach out for press releases, interviews, background information, or story ideas. We\'re happy to discuss our nonprofit mission, impact on the open source ecosystem, and unique funding model.'
  },
  {
    id: 'support',
    label: 'Get Help',
    ...
    details: 'Experiencing technical difficulties with our platform? Let us know what issue you\'re facing, and our support team will help troubleshoot. Please include details about what you were trying to do and any error messages you received.'
  },
  {
    id: 'general',
    ...
    details: 'Have questions about how our platform works, our nonprofit structure, how funds are distributed, or anything else? We\'re here to help. Check our FAQ page for quick answers to common questions.'
  }
];

export function ContactPage({ onNavigateHome, onNavItemClick, demoState }: ContactPageProps) {
  ...
  const [submissionStatus, setSubmissionStatus] = useState<'idle' | 'success' | 'error'>(demoState || 'idle');
  const [fieldErrors, setFieldErrors] = useState<Record<string, string>>({});
  
  // Apply demo state when prop changes
  React.useEffect(() => {
    if (demoState) {
      setSubmissionStatus(demoState === 'submitting' ? 'idle' : demoState);
      setIsSubmitting(demoState === 'submitting');
    }
  }, [demoState]);
  ...
  const handleInputChange = (field: keyof FormData, value: string | boolean) => {
    setFormData(prev => ({ 
      ...prev, 
      [field]: typeof value === 'string' && value === 'true' ? true : 
  ...
  return (
    <div className="min-h-screen flex flex-col bg-brand-neutral-100">
      <Header 
        ...
        onDeveloperRegister={() => onNavItemClick('maintainer-registration')}
      />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          <div className="space-y-6">
            <div className="space-y-4">
              <h1 className="text-brand-neutral-950">
                Contact Us
              </h1>
              ...
              <div className="pt-6 border-t border-brand-neutral-300 space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <a 
                      href="mailto:contact@opensourceeconomy.org"
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <button
                      ...
                      className="text-brand-accent hover:text-brand-accent-dark transition-colors inline-flex items-center gap-1 group"
                    >
                      Visit FAQ
                    ...
                    <div className="mb-8">
                      ...
                      <p className="text-brand-neutral-600">
                        {selectedReason 
                          ...
                          : 'Select an inquiry type to get started'
                        }
                      </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} noValidate className="space-y-6">
                      ...
                      {!formData.contactReason ? (
                        ...
                        <>
                            ...
                            <div>
                              ...
                              {formData.contactReason === 'maintainer' && (
                                <p className="text-brand-neutral-600 mt-2 flex items-center gap-2">
                                  ...
                                  <span>
                                    We'll review your GitHub profile to verify your open source contributions and expertise.
                                  </span>
                                </p>
                              )}
                            </div>
                          ...
                          {(formData.contactReason === 'enterprise' || formData.contactReason === 'partnership' || formData.contactReason === 'press') && (
                              ...
                              <div className="flex items-start gap-3">
                                <Checkbox
                                  ...
                                  onCheckedChange={(checked) => 
                                    handleInputChange('requestMeeting', checked === true)
                                  }
                                  className="mt-1"
                                />
                                <div className="flex-1">
                                  <Label 
                                    htmlFor="requestMeeting" 
                                    className="cursor-pointer text-brand-neutral-800 flex items-center gap-2"
                                  >
                                  ...
                                  <p className="text-brand-neutral-600 mt-1">
                                    Request a video call to discuss your needs in detail
                                  </p>
                                </div>
                              </div>
                          ...
                          <div className="pt-6 border-t border-brand-neutral-300">
                            <p className="text-brand-neutral-600 caption text-center">
      ...
      {/* Demo State Switcher - Development Tool */}
      <section className="bg-brand-neutral-200 border-t border-brand-neutral-300 py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-brand-card-blue border border-brand-neutral-300 rounded-lg p-6">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                <h3 className="text-brand-neutral-900 mb-1">
                  Demo State Switcher
                </h3>
                <p className="text-brand-neutral-600 caption">
                  Test different form states (development tool)
                </p>
              </div>
              <div className="flex flex-wrap gap-2">
                <Button
                  ...
                  className={!demoState ? 'bg-brand-accent text-white hover:bg-brand-accent-dark' : ''}
                >
                  Idle State
                </Button>
                <Button
                  variant="outline"
                  size="sm"
                  onClick={() => onNavItemClick('contact-submitting')}
                  className={demoState === 'submitting' ? 'bg-brand-accent text-white hover:bg-brand-accent-dark' : ''}
                >
                ...
                <Button
                  variant="outline"
                  size="sm"
                  onClick={() => onNavItemClick('contact-success')}
                  className={demoState === 'success' ? 'bg-brand-success text-white hover:bg-brand-success-dark' : ''}
                >
                ...
                <Button
                  variant="outline"
                  size="sm"
                  onClick={() => onNavItemClick('contact-error')}
                  className={demoState === 'error' ? 'bg-brand-error text-white hover:bg-brand-error-dark' : ''}
                >
