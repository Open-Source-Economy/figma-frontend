...
import { Home, ArrowLeft, Search, BookOpen, Briefcase, MessageSquare } from 'lucide-react';
...
export function NotFoundPage({ onNavigateHome, onNavItemClick }: NotFoundPageProps) {
  const quickLinks = [
    {
      icon: Home,
      label: 'Home',
