...
import { TrendingUp, Package, Code, Briefcase, Users, Target } from 'lucide-react';
    ...
    <div className="max-w-4xl">
      ...
      <div className="space-y-8">
        {tiers.map((tier, idx) => {
          ...
          return (
            <Card key={tier.id} className={`border-2 transition-all ${
              isActive 
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <div className="text-right">
                        <div className={`text-2xl text-${tier.color}`}>
                          {progress.toFixed(0)}%
                        </div>
